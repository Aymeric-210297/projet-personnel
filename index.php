...
<body>
    ...
    <main>
        ...
        <p id="lienAgence"><a href="#" target="_blank" title="Aller à l'agence">Voir
                l'agence</a></p>
        <div class="flex wrap space-around">
            <div class="border card">
                ...
                <div>
                    ...
                    <div class="center">
                        <p><span>250m²</span> - <span>Ville</span></p>
                        <h3>250000€</h3>
            ...
            <div class="border card">
                ...
                <div>
                    ...
                    <div class="center">
                        <p><span>300m²</span> - <span>Ville</span></p>
                        <h3>310000€</h3>
                        <a href="voirLeBien" class="btn btn-page">Voir le bien</a>
                    </div>
                </div>
            ...
            <div class="border card">
                ...
                <div>
                    ...
                    <div class="center">
                        <p><span>150m²</span> - <span>Ville</span></p>
                        <h3>250000€</h3>
                        <a href="voirLeBien" class="btn btn-page">Voir le bien</a>
                    </div>
                </div>
